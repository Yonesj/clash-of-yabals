...
public class Map2Controller extends MapController implements Initializable {
    ...
    private boolean isGoblinSelected = false;
    private boolean isAttackStarted;
    private int giantCount = 5;
    private int barbarCount = 5;
    private int archerCount = 5;
    private int goblinCount = 5;
    ...
    @FXML
    private Rectangle goblinSelected;
...
//                    result.getInt("level"), result.getString("map"));
    ...
    void selectGoblin(){
        ...
        isBarbarSelected = false;
        isArcherSelected = false;
        isGoblinSelected = true;

        barbarSelected.setVisible(false);
        giantSelected.setVisible(false);
        archerSelected.setVisible(false);
        goblinSelected.setVisible(true);
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Image goblinImage = new Image("goblin_4.png");
        ...
        map.setOnMouseClicked(event -> {
            if (attackMode && isAttackStarted) {
                ...
                if (isBarbarSelected && (barbarCount != 0)) {
                    ...
                    troop = new Troop(x, y, hero, heroHp, currentMap.getBuildings(), 1300, 100, 0, 40, FavoriteTarget.DEFENCE, "These big guys may seem calm, but show them a turret or cannon and you'll see their fury unleashed! Slow yet durable, these warriors are best used to soak up hits");
                    giantCount--;
                    ...
                    archerCount--;
                } else if (isGoblinSelected && (goblinCount != 0)) {
                    hero.setImage(goblinImage);
                    hero.setFitWidth(40);
                    hero.setFitHeight(50);
