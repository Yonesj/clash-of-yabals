...
public class Buildings {
    ...
    public static Building goldMine_1 = new Building(1000,"The Gold Mine produces gold. Upgrade it to boost its production and gold storage capacity.");
    ...
    public static Building goldStorage_1 = new Building(2000,"All your precious gold is stored here. Don't let sneaky goblins anywhere near!");

    public static Building exirStorage_1 = new Building(2000,"These storages contain the elixir pumped from underground.");
